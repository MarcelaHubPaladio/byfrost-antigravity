...
const SUPABASE_URL = process.env.SUPABASE_URL || "https://pryoirzeghatrgecwrci.supabase.co"; // URL from screenshot log? Or standard env
...
async function run() {
    ...
    if (entityId) {
        ...
        // Check last few messages generally
        const { data: recent } = await supabase
            ...
            .limit(5);
        console.log("Recent 5 message phones:", recent);
    }

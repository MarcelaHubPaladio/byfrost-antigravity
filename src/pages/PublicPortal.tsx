            ...
            customSectionsMap[section.id] = (
                <section 
                    ...
                    style={{
                        ...
                        marginTop: effectiveSettings.style?.margin?.top ? `${effectiveSettings.style.margin.top}px` : undefined,
                        marginBottom: effectiveSettings.style?.margin?.bottom ? `${effectiveSettings.style.margin.bottom}px` : undefined,
                        marginLeft: effectiveSettings.style?.margin?.left ? `${effectiveSettings.style.margin.left}px` : undefined,
                        marginRight: effectiveSettings.style?.margin?.right ? `${effectiveSettings.style.margin.right}px` : undefined,
                        paddingTop: effectiveSettings.style?.padding?.top ? `${effectiveSettings.style.padding.top}px` : effectiveSettings.paddingY ? `${effectiveSettings.paddingY}px` : undefined,
                        paddingBottom: effectiveSettings.style?.padding?.bottom ? `${effectiveSettings.style.padding.bottom}px` : effectiveSettings.paddingY ? `${effectiveSettings.paddingY}px` : undefined,
                        paddingLeft: effectiveSettings.style?.padding?.left ? `${effectiveSettings.style.padding.left}px` : isMobile ? '16px' : effectiveSettings.paddingX ? `${effectiveSettings.paddingX}px` : '32px',
                        paddingRight: effectiveSettings.style?.padding?.right ? `${effectiveSettings.style.padding.right}px` : isMobile ? '16px' : effectiveSettings.paddingX ? `${effectiveSettings.paddingX}px` : '32px',
                                ...
                                section.columns.map((col: any) => {
                                    ...
                                    return (
                                        <div 
                                            ...
                                            className={cn("flex flex-col gap-4 relative", colSettings.cssClasses || '')}
                                        >

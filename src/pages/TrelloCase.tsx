...
export default function TrelloCase() {
    const { id } = useParams();
    ...
    const caseQ = useQuery({
        ...
        queryFn: async () => {
            const { data, error } = await supabase
                .from("cases")
                .select(
                    "id,tenant_id,case_type,customer_id,title,status,state,created_at,updated_at,assigned_user_id,is_chat,users_profile:users_profile!fk_cases_users_profile(display_name,email),journeys:journeys!cases_journey_id_fkey(key,name,is_crm,default_state_machine_json)"
                )
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0">
                                ...
                                <div className="flex items-center gap-2 text-xs text-slate-500">
                                    ...
                                    <Badge variant="secondary" className="rounded-full">Trello</Badge>
                                </div>
                            </div>
                        </div>

-- Migration: Update process_zapi_inbound_message to scope case searches by assigned user
-- Description: Restricts case resolution so multi-instance setups correctly associate or create cases for their specific user.

...
as $$
  select 
    ...
    (select coalesce(sum((metrics_json->>'ai_tokens')::bigint), 0) from public.usage_counters uc where uc.tenant_id = t.id and uc.deleted_at is null) as ai_tokens_count

-- Migration 0059: Fix Goal Triggers occurred_at error
...
begin
    ...
    loop
        ...
        -- Insert the goal progress event (use created_at instead of occurred_at, because occurred_at doesn't exist on incentive_events)

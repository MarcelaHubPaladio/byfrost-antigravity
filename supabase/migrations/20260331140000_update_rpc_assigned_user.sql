-- Migration: Update process_zapi_inbound_message to support assigned_user_id
-- Description: Adds p_assigned_user_id parameter to the RPC to automatically assign new cases and customer accounts.
...
create or replace function public.process_zapi_inbound_message(
    ...
    p_assigned_user_id uuid default null -- Added parameter
)
returns table (
    ok boolean,
    case_id uuid,
